    ...
    <div class="top-bar-boxed h-[70px] z-[51] relative border-b border-white/[0.08] mt-12 md:-mt-5 -mx-3 sm:-mx-8 px-3 sm:px-8 md:pt-0 mb-12">
        <div class="h-full flex items-center">
            ...
            <a href="" class="-intro-x hidden md:flex">
                ...
                <span class="text-white text-lg ml-3"> Ulwah Store </span>
            </a>
            <!-- END: Logo -->
            <!-- BEGIN: Breadcrumb -->
            ...
            <nav class="side-nav">
                <ul>
                    ...
                    <li>
                        ...
                        <ul class="">
                            <li>
                                <a href="<?= base_url('categories/sandal') ?>" class="side-menu">
                                    <div class="menu__icon">Sandal Flat</div>
                                </a>
                            </li>
                            <li>
                                <a href="<?= base_url('categories/flatshoes') ?>" class="side-menu">
                                    <div class="menu__icon">Flat Shoes</div>
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="<?= base_url('categories/Mules') ?>" class="side-menu">
                                    <div class="menu__icon">Mules</div>
                                </a>
                            </li>
                        </ul>
